Crazy Kingdom: copy, then star the page, press more, on the second bar, delete it all and copy and paste it, press  ctrl+A, this highlights it all,
press the bottom left arrow  (your bottom left arrow,), and type: javascript with a lowercase, and a colon straight after it without a space, then press 
spacebar once and click  'Save'.  It would look like this:    javascript: etc., but MAKE SURE YOU PUT ONE SPACE AFTER THE COLON- note that 'javascript' is a lowercase 'j'
